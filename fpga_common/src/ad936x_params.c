...
AD9361_InitParam bladerf2_rfic_init_params_fastagc_burst = {
    ...
    0,              // (NO - TDD) use FDD mode                                                     // frequency_division_duplex_mode_enable *** adi,frequency-division-duplex-mode-enable
    0,              // (NO - TDD) use independent FDD mode                                         // frequency_division_duplex_independent_mode_enable *** adi,frequency-division-duplex-independent-mode-enable
    1,              // (YES for TDD) N/A when frequency_division_duplex_mode_enable = 1               // tdd_use_dual_synth_mode_enable *** adi,tdd-use-dual-synth-mode-enable
    0,              // (NO for TDD)  N/A when frequency_division_duplex_mode_enable = 1               // tdd_skip_vco_cal_enable *** adi,tdd-skip-vco-cal-enable
    ...
    /* Fast AGC - Low Power */
    1,              // Should increase stability to allow                               // fagc_allow_agc_gain_increase ***  adi,fagc-allow-agc-gain-increase-enable
